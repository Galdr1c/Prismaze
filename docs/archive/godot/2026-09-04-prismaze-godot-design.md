...
> Bu belgedeki motor kararları, yollar ve durum ifadeleri yalnız eski Godot
> projesine aittir; Unity test veya build kanıtı değildir. Kaynak: `LegacyGodot/`.
> Aktif belge: [Unity tasarımı](../../superpowers/specs/2026-09-06-prismaze-unity-design.md).
