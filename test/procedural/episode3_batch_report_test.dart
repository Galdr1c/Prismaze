// Episode 3 batch validation with saved report
// Run with: flutter test test/procedural/episode3_batch_report_test.dart --no-pub
...
void main() {
  test('Episode 3 batch validation with report', () {
    print('\n=========================================');
    ...
    if (movesList.isNotEmpty) {
      ...
      report.writeln('- p75: ${movesList[(movesList.length * 0.75).floor()]}');
